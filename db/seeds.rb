...
entries = [
  ...
  ["Third Place:Walkon Open #3", "Patricia, Carolyn and Michele", "Hua, Bao, and Feng from Powerpuff Dynasty (original concept)", 1, 5],
  ["Second Place:Walkon Open #28", "Kyle, Taylor, Rissa and Megan", "Double, Painwheel, Regina and Black Dahlia from Skullgirls", 1, 5],
  ["Best in Show (For Division):Walkon Open #22", "Black Waltz 2 from Final Fantasy 9", "Silver Faction", 1, 5],
  ["Third Place Walkon Advanced #5", "Shouri Cosplay Troupe", "Princess Sakura, Syaoran and Fai D. Flowright from Tsubasa Reservoir Chronicle", 1, 6],
  ["Second Place Walkon Advanced #10", "Eva Birch", "Sialynn the Celestial Battle Nymph, personal bodyguard of Queen Titania from Midsummer Night’s Dream (original concept)", 1, 6],
  ...
  ["Second Place", "Jordan K", "Steampunk Hawkgirl", 1, 12],
  ["Third Place", "Katie B", "Bluebird", 1, 12],
  ["First Place", "Eddy C", "Warrior Alien", 1, 13],
  ["Second Place", "Lynn Martin", "Aereon", 1, 13],
  ["Third Place", "Stephanie Jurado-Smith", "Effie Trinket", 1, 13],
  ["First Place", "Mary Mann", "Princess Celestia", 1, 14],
  ["Second Place", "Gigawatts Cosplay", "Elsa", 1, 14],
  ["Third Place", "Benny G Cosplay", "D&D Paladin", 1, 14],
  ["First Place", "Julia Alfano", "Demon Hunter", 1, 15],
  ["Second Place", "Ashley D", "Samara the Justicar", 1, 15],
  ["Third Place", "Tiger Tessa", "Snowstorm Sivir", 1, 15],
  ...
  ["Second Place", "Anna B and others", "Snow White, Belle, Ariel", 1, 16],
  ["Third Place", "Alex Baker and other", "Judges Dredd and Anderson", 1, 16]
]
